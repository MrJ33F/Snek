...
import project.android.snek.multiplayer.model.DirectionChangedMessage;
import project.android.snek.multiplayer.model.GameState;
...
public class AndroidClient {
    ...
    private AndroidClient(Context context) {
        this.client = Stomp.over(Stomp.ConnectionProvider.JWS, WEBSOCKET_URL);
    ...
    public Single<GameState> join(String gameId) {
        ...
        return new Single<GameState>() {
            ...
            protected void subscribeActual(SingleObserver<? super GameState> observer) {
                CustomRequest<PlayerJoinMessage ,GameState> postReq = new CustomRequest<>(Request.Method.POST, url,
