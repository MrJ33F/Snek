...
public class FoodManager extends View implements FoodProvider {
    ...
    private static final int COLUMNS = GameConstants.WIDTH / GameConstants.FOOD_DISTRICT_SIZE;
    private static final int ROWS = GameConstants.WIDTH / GameConstants.FOOD_DISTRICT_SIZE;
    ...
    private void init() {
        IntStream.range(0, GameConstants.FOOD_COUNT)
    ...
    private int district(Vector position) {
        int x = (int) position.x / GameConstants.FOOD_DISTRICT_SIZE;
        int y = (int) position.y / GameConstants.FOOD_DISTRICT_SIZE;
